...
<div>
   ...
   <div class="h-full px-3 pb-4 overflow-y-auto bg-white ">
      <ul class="space-y-2 font-medium">
         <li>
            <a href="{{ route('dashboard') }}" wire:navigate class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
         ...
         <li>
            <a href="{{ route('cashier') }}" wire:navigate class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
               
               <span class="ms-3">Cashier</span>
            </a>
         </li>
         <li>
         ...
         <li>
            <a href="{{ route('products') }}" wire:navigate class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
