...
<div class="min-h-screen  font-Montserrat text-primary-text">
    ...
    class="fixed top-0 left-0 right-0 z-50 transition-all duration-300">
            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex-shrink-0">
                    <a href="#" class="flex items-center space-x-3 group">
                        <div class="relative">
                            <div class="absolute inset-0 bg-amber-500 rounded-full blur-md opacity-50 group-hover:opacity-75 transition-opacity"></div>
                            <svg class="w-10 h-10 text-amber-500 relative z-10" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M18.5 2c1.38 0 2.5 1.12 2.5 2.5V6h-3V4.5c0-.28-.22-.5-.5-.5s-.5.22-.5.5V6h-3V4.5c0-.28-.22-.5-.5-.5s-.5.22-.5.5V6H8V4.5c0-.28-.22-.5-.5-.5s-.5.22-.5.5V6H4V4.5C4 3.12 5.12 2 6.5 2h12zM4 19c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8H4v11zm8-9c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5-1.5-.67-1.5-1.5.67-1.5 1.5-1.5z"/>
                            </svg>
                        </div>
                        <div>
                            <h1 class="text-2xl font-Playfair font-bold text-white">Qio Coffee</h1>
                            <p class="text-xs text-amber-500">Street Coffee Experience</p>
                        </div>
                    </a>
                </div>
                ...
                <div class="hidden md:flex items-center space-x-1">
                    ...
                    <a href="#menu" class="px-4 py-2 text-white hover:text-amber-500 transition-colors duration-200 font-medium relative group">
                        Menu
                        <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-amber-500 group-hover:w-full transition-all duration-300"></span>
                    </a>
                    <a href="#gallery" class="px-4 py-2 text-white hover:text-amber-500 transition-colors duration-200 font-medium relative group">
                        Galeri
                        <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-amber-500 group-hover:w-full transition-all duration-300"></span>
                    </a>
                </div>
                ...
                <div class="hidden md:flex items-center space-x-4">
                    <a href="#menu" class="px-6 py-2.5 bg-amber-600 hover:bg-amber-700 text-white font-semibold rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center space-x-2">
                ...
                <div class="md:hidden flex items-center">
                    <button @click="isOpen = !isOpen" class="text-white hover:text-amber-500 focus:outline-none transition-colors">
        ...
        <div x-show="isOpen"
            ...
            <div class="px-4 pt-4 pb-6 space-y-2">
                ...
                <a href="#menu" @click="isOpen = false" class="block px-4 py-3 text-white hover:text-amber-500 hover:bg-white/5 rounded-lg transition-all duration-200 font-medium">
                    Menu
                </a>
                <a href="#gallery" @click="isOpen = false" class="block px-4 py-3 text-white hover:text-amber-500 hover:bg-white/5 rounded-lg transition-all duration-200 font-medium">
                    Galeri
                </a>
                <div class="pt-4">
                    <a href="#menu" @click="isOpen = false" class="block w-full px-6 py-3 bg-amber-600 hover:bg-amber-700 text-white font-semibold rounded-full transition-all duration-300 text-center shadow-lg">
                        Order Now
                    </a>
                </div>
            </div>
    ...
    <main id="home">
        <!-- Hero Section -->
        <section class="relative min-h-screen flex items-center justify-center overflow-hidden px-8" x-data="{}" @scroll.window="let scrollPosition = window.pageYOffset; if (scrollPosition < window.innerHeight) { $refs.heroImage.style.transform = `scale(1.2) translateY(${scrollPosition * 0.3}px)`; }">
            ...
            <div class="relative z-20 text-center max-w-4xl mx-auto">
                <div class="mb-6">
                    <h1 class="text-6xl md:text-8xl font-Playfair font-bold text-white mb-4 tracking-wide">
                        Welcome
                    </h1>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <a href="#menu" role="button" class="inline-block px-8 py-4 bg-amber-600 hover:bg-amber-700 text-white font-semibold rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
                        Lihat Menu Kami
                    </a>
                    <a href="#about" role="button" class="inline-block px-8 py-4 bg-transparent border-2 border-white text-white font-semibold rounded-full hover:bg-white hover:text-gray-900 transition-all duration-300 shadow-lg">
                        Tentang Kami
                    </a>
                </div>
        ...
        <section id="about" class="py-20 px-8 bg-white">
            <div class="max-w-6xl mx-auto">
                <div class="text-center mb-16">
                    <h2 class="text-4xl md:text-5xl font-Playfair font-bold text-gray-900 mb-4">Tentang Kami</h2>
                    <div class="w-24 h-1 bg-amber-500 mx-auto mb-8"></div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="space-y-6">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            Qio Coffee didirikan pada tahun 2020 dengan visi sederhana: menyajikan kopi berkualitas tinggi dengan harga terjangkau. Kami memulai sebagai kedai kopi kecil di sudut jalan, dan kini telah berkembang menjadi destinasi kopi favorit di kota ini.
                        </p>
                        <p class="text-gray-600 leading-relaxed">
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-8">
                            ...
                            <div class="text-center p-4 border border-gray-200 rounded-lg hover:border-amber-500 transition-all">
                                ...
                                <p class="text-sm text-gray-500">Tempat yang nyaman untuk bersantai</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="menu" class="py-20 px-8 bg-gray-100">
            <div class="max-w-6xl mx-auto">
                <div class="text-center mb-16">
                    <h2 class="text-4xl md:text-5xl font-Playfair font-bold text-gray-900 mb-4">Menu Kami</h2>
                    <div class="w-24 h-1 bg-amber-500 mx-auto mb-8"></div>
                        ...
                        <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all duration-300">
                            ...
                            <div class="p-6">
                                <div class="flex justify-between items-center mb-4">
                                    ...
                                    <span class="text-amber-600 font-bold">Rp {{ number_format($product->price, 0, ',', '.') }}</span>
                                </div>
        ...
        <section id="testimonials" class="py-20 px-8 bg-gradient-to-br from-gray-50 to-gray-100">
            <div class="max-w-6xl mx-auto">
                <div class="text-center mb-16">
                    <h2 class="text-4xl md:text-5xl font-Playfair font-bold text-gray-900 mb-4">Apa Kata Mereka</h2>
                    <div class="w-24 h-1 bg-amber-500 mx-auto mb-8"></div>
                        ...
                        <template x-for="(testimonial, index) in testimonials" :key="index">
                            <div x-show="currentSlide === index"
                                ...
                                <div class="flex flex-col items-center">
                                    ...
                                    <h4 class="text-xl font-semibold text-gray-900" x-text="testimonial.name"></h4>
                                    <p class="text-amber-600 font-medium mb-1" x-text="testimonial.role"></p>
                                    <p class="text-gray-500 text-sm" x-text="testimonial.date"></p>
                                </div>
                            </div>
                        </template>
                    </div>
        ...
        <section id="gallery" class="py-20 px-8 bg-white">
            <div class="max-w-6xl mx-auto">
                <div class="text-center mb-16">
                    <h2 class="text-4xl md:text-5xl font-Playfair font-bold text-gray-900 mb-4">Galeri Kami</h2>
                    <div class="w-24 h-1 bg-amber-500 mx-auto mb-8"></div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div class="relative overflow-hidden rounded-lg shadow-lg lg:col-span-2 lg:row-span-2 group">
                        <img src="https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=800" alt="Coffee Shop Interior" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                            <h3 class="text-white text-xl font-semibold">Interior Qio Coffee</h3>
                    ...
                    <div class="relative overflow-hidden rounded-lg shadow-lg group">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                            <h3 class="text-white text-lg font-semibold">Proses Brewing</h3>
                    ...
                    <div class="relative overflow-hidden rounded-lg shadow-lg group">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                            <h3 class="text-white text-lg font-semibold">Biji Kopi Pilihan</h3>
                    ...
                    <div class="relative overflow-hidden rounded-lg shadow-lg group">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                            <h3 class="text-white text-lg font-semibold">Event Spesial</h3>
                    ...
                    <div class="relative overflow-hidden rounded-lg shadow-lg group">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                            <h3 class="text-white text-lg font-semibold">Dessert Spesial</h3>
                            <p class="text-gray-200 mt-2">Pendamping sempurna untuk kopi Anda</p>
                        </div>
                    </div>
                </div>
     ...
     <!-- Footer -->
    <footer class="relative bg-gradient-to-br from-stone-900 to-black text-white py-20 px-8 overflow-hidden">
        <!-- Decorative Background Elements -->
        <div class="absolute inset-0 opacity-5">
            <div class="absolute top-10 left-10 w-32 h-32 border border-amber-500 rounded-full"></div>
            <div class="absolute bottom-20 right-20 w-40 h-40 border border-amber-500 rounded-full"></div>
            <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <svg class="w-64 h-64 text-amber-600 opacity-30" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="max-w-6xl mx-auto relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                <!-- About Column -->
                <div>
                    <h3 class="text-lg font-semibold text-amber-500 mb-6 font-Playfair">Tentang Kami</h3>
                    <ul class="space-y-3 text-gray-400">
                        <li><a href="#about" class="hover:text-amber-500 transition-colors duration-200 flex items-center group">
                            <span class="w-0 group-hover:w-2 h-0.5 bg-amber-500 mr-0 group-hover:mr-2 transition-all duration-200"></span>
                            Kisah Kami
                        </a></li>
                        <li><a href="#" class="hover:text-amber-500 transition-colors duration-200 flex items-center group">
                            <span class="w-0 group-hover:w-2 h-0.5 bg-amber-500 mr-0 group-hover:mr-2 transition-all duration-200"></span>
                            Tim Barista
                        </a></li>
                        <li><a href="#" class="hover:text-amber-500 transition-colors duration-200 flex items-center group">
                ...
                <!-- Menu Column -->
                <div>
                    <h3 class="text-lg font-semibold text-amber-500 mb-6 font-Playfair">Menu</h3>
                    <ul class="space-y-3 text-gray-400">
                        <li><a href="#menu" class="hover:text-amber-500 transition-colors duration-200 flex items-center group">
                            <span class="w-0 group-hover:w-2 h-0.5 bg-amber-500 mr-0 group-hover:mr-2 transition-all duration-200"></span>
                            Kopi Signature
                        </a></li>
                        <li><a href="#menu" class="hover:text-amber-500 transition-colors duration-200 flex items-center group">
                ...
                <!-- Contact Column -->
                <div>
                    <h3 class="text-lg font-semibold text-amber-500 mb-6 font-Playfair">Hubungi Kami</h3>
                    <ul class="space-y-4 text-gray-400">
                        <li class="flex items-start">
                            ...
                            <span>Jl. Kopi Kenangan No. 99<br>Medan, Sumatera Utara</span>
                        </li>
                ...
                <!-- Hours Column -->
                <div>
                    <h3 class="text-lg font-semibold text-amber-500 mb-6 font-Playfair">Jam Operasional</h3>
                    <div class="space-y-3 text-gray-400">
                        ...
                        <div class="flex items-center justify-between pb-3 border-b border-gray-700 mt-4">
            ...
            <div class="border-t border-gray-800 pt-12 pb-8">
                <div class="flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <div class="text-center md:text-left">
                        <h4 class="text-amber-500 font-semibold mb-4">Ikuti Kami</h4>
                        <div class="flex space-x-4">
                            <a href="#" class="w-10 h-10 rounded-full bg-white/5 hover:bg-amber-600 border border-gray-700 hover:border-amber-600 flex items-center justify-center text-gray-400 hover:text-white transition-all duration-300">
                    ...
                    <div class="text-center md:text-right">
                        <h4 class="text-amber-500 font-semibold mb-4">Newsletter</h4>
                        <form class="flex flex-col sm:flex-row gap-2">
                            <input type="email" placeholder="Email Anda" class="px-4 py-2 bg-white/5 border border-gray-700 rounded-full text-gray-300 placeholder-gray-500 focus:outline-none focus:border-amber-500 transition-colors">
                            <button type="submit" class="px-6 py-2 bg-amber-600 hover:bg-amber-700 text-white font-semibold rounded-full transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105">
                                Subscribe
                            </button>
                        </form>
                    </div>
            ...
            <div class="border-t border-gray-800 pt-8 mt-8 text-center text-gray-500 text-sm">
                <p>&copy; 2025 Qio Coffee. All rights reserved. Made with <span class="text-amber-500">❤</span> in Medan.</p>
            </div>
        </div>

        <!-- Back to Top Button -->
        <div class="fixed bottom-8 right-8 z-40" x-data="{ show: false }" @scroll.window="show = (window.pageYOffset > 300)" x-show="show" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 transform translate-y-0" x-transition:leave-end="opacity-0 transform translate-y-4">
            <a href="#home" title="Back to Top" class="flex flex-col items-center group">
                <div class="w-12 h-12 bg-amber-600 hover:bg-amber-700 rounded-full flex items-center justify-center shadow-lg transition-all duration-300 transform group-hover:scale-110">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18"></path>
                    </svg>
                </div>
                <span class="text-xs text-white mt-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">Back to Top</span>
            </a>
        </div>
    </footer>
